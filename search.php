    ...
    <section class="blog-hero">
        <div class="wrapper__border">
            <div class="blog-hero__inner container">
                <span class="posts-section__label">Hasil Pencarian</span>
                <h1 class="blog-title">
                    <?php
                    /* translators: %s: search query. */
                    printf( esc_html__( 'Hasil Pencarian untuk: "%s"', 'era-ai' ), get_search_query() );
                    ?>
                </h1>
            </div>
        </div>
            ...
            <div class="blog-posts__inner container">
                ...
                <div class="grid-cards filter-grid">
                    <?php if ( have_posts() ) : ?>
                        ...
                        <?php endwhile; ?>
                    <?php else : ?>
                        <p class="error-msg">Tidak ada artikel yang cocok dengan pencarian Anda.</p>
                    <?php endif; ?>
                </div>
